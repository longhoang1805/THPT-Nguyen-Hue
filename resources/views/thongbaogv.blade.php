            ...
            <div class="container-fluid">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a class="btn btn-sm download" href="{{ url('giao-vien/themthongbao') }}">
                            <i class="material-icons">
                                notification_add
                            </i>
                            Thêm thông báo mới
                            ...
                            <div class="container">
                                <div class="row thong-bao">
                                    <div class="col-sm-9" style="margin-left: 3%">
                                        <a href="{{ url('giao-vien/thongbaogv/' . $item->id) }}">
                                            <div>
                                                <div>
                                    ...
                                    <div class="col-sm-2">
                                        <a href="{{ url('giao-vien/suathongbao/' . $item->id) }}"
                                            class="edit btn btn-primary btn-sm">Sửa</a>
                                        <a href="{{ url('giao-vien/xoathongbao/' . $item->id) }}"
